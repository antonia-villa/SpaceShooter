...
function create(){
  ...
  pewpew = game.add.audio('pewpew', 0.2, false);
  ...
  player.body.collideWorldBounds = true; // Does not allow player to go outside the bounds of the box
  player.score = 0; // made up - not included in phaser
